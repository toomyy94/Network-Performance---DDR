...
txia = pkt_Sender(env,'I',lambi,'A') 
txib = pkt_Sender(env,'B',lambi,'B')
...
total_lost = link12.lost_pkts+link23.lost_pkts+link31.lost_pkts+link32.lost_pkts+link34.lost_pkts+link4I.lost_pkts+node1.lost_pkts+node2.lost_pkts+node3.lost_pkts+node4.lost_pkts

print('total loss:%.2f%%'%(100.0*(total_lost)/(txa.packets_sent+txb.packets_sent+txia.packets_sent+txib.packets_sent)) ) 
